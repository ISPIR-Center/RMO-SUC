    ...
    <nav id="sidebar">
        <div class="pt-3">
          ...
          <ul class="nav flex-column list-group">
            ...
            <x-navbar.li :navstatus="$active" name="deanrbp">
              ...
              <div class="pl-4">
                  <ul class="collapse collapse-group list-unstyled" id="manageProposal">
                      <li class="collapse-item">
                          <a href="{{ route('dean-rbp')}}"><ion-icon name="folder-outline" class="pr-2" size="medium"></ion-icon> Research Based Paper</a>
                      </li> 
                  </ul>
            ...
            <x-navbar.li :navstatus="$active" name="deanpending">
              <a class="nav-item-link" href="{{ route('dean-pending') }}"><ion-icon name="document-text-outline" size="large"></ion-icon> Pending </a>
            </x-navbar.li>
    
              <x-navbar.li :navstatus="$active" name="deanrevision">
                <a class="nav-item-link" href="{{ route('dean-revision') }}"><ion-icon name="document-text-outline" size="large"></ion-icon>For Revision </a>
              </x-navbar.li>
            
            
              <x-navbar.li :navstatus="$active" name="deanchangepassword">
                      <a href="{{ route('dean-change') }}"><ion-icon name="lock-open-outline" size="large"></ion-icon> Change Password</a>
