       ...
       <tbody>
        ...
        @foreach ($paperpresenteds as $paperpresented)
         <tr class="unread text-center">
           ...
           <td>
            <a href="/rmo/paper-presented/view/{{$paperpresented->id}}/{{ $proposal->id }}" class="btn btn-secondary float-center"><i class="fas fa-eye"></i></a>
           </td>
         </tr>
         @endforeach
            @else
     ...
     <tbody>
      ...
      @foreach ($paperpublisheds as $paperpublished)
       <tr class="unread text-center">
         ...
         <td>
          <a href="/rmo/paper-published/view/{{$paperpublished->id}}/{{ $proposal->id }}" class="btn btn-secondary float-center"><i class="fas fa-eye"></i></a>
         </td>
       </tr>
      </tr>
      <!-- DELETE UTILIZED -->
