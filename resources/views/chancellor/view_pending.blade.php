           ...
           <td>
             <div class="w-25 dropdown pl-4">
               ...
               <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                 <a href="{{ route('chancellor-paperpresented-view', $paperpresented->id) }}" class="dropdown-btn dropdown-item"><i class="fa fa-eye"></i> View</a>
                 {{-- @if ($paperpresented->status =="APPROVED")
                 <a href="{{ route('chancellor-paperpresented-edit', $paperpresented->id) }}" class="dropdown-btn dropdown-item" aria-disabled="true"><i class="fa fa-edit"></i> Edit</a>
                 @else
                 <a href="/chancellor/paper-presented/edit/{{$proposal->id}}/{{$paperpresented->id}}" class="dropdown-btn dropdown-item"><i class="fa fa-edit"></i> Edit</a>
                 @endif --}}
                 <hr>
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body text-center">
          ...
          <form action="{{ route('chancellor-presented-delete', $paperpresented->id) }}" method="post">
            @csrf
     ...
     @if ($proposal->status== "PENDING" && $proposal->location_to == "Chancellor" || $proposal->status == "APPROVED")
     <div class="mt-2">
      <a href="{{ url('/chancellor/paper-presented/create/'.$proposal->id) }}" class="btn btn-primary float-right px-3" type="submit"><i class="fas fa-plus pr-2"></i> ADD</a>
    </div>
    @else
    @endif
   </div>
       ...
       <tr class="unread text-center">
         ...
         <td>
           <div class="w-25 dropdown pl-4">
             ...
             <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
               <a href="{{ route('chancellor-paperpublished-view', $paperpublished->id) }}" class="dropdown-btn dropdown-item"><i class="fa fa-eye"></i> View</a>
               {{-- @if ($paperpublished->status =="APPROVED")
               <a href="{{ route('chancellor-paperpublished-edit', $paperpublished->id) }}" class="dropdown-btn dropdown-item" aria-disabled="true"><i class="fa fa-edit"></i> Edit</a>
               @else
               <a href="/chancellor/paper-published/edit/{{$proposal->id}}/{{$paperpublished->id}}" class="dropdown-btn dropdown-item"><i class="fa fa-edit"></i> Edit</a>
               @endif --}}
               <hr>
...
<div class="modal-dialog" role="document">
  <div class="modal-content">
   ...
   @if ($proposal->status== "PENDING" && $proposal->location_to == "Chancellor" || $proposal->status == "APPROVED")
   <div class="mt-2">
     <a href="{{ url('/chancellor/paper-published/create/'.$proposal->id) }}" class="btn btn-primary float-right px-3"><i class="fas fa-plus pr-2"></i> ADD</a>
   @endif
    </div>
 </div>
         ...
         <td>
           <div class="w-25 dropdown pl-4">
             ...
             <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
               ...
               <a href="{{ route('chancellor-journalcited-edit', $journalcited->id) }}" class="dropdown-btn dropdown-item" aria-disabled="true"><i class="fa fa-edit"></i> Edit</a>
               @else
               <a href="/chancellor/journal-cited/edit/{{$proposal->id}}/{{$journalcited->id}}" class="dropdown-btn dropdown-item"><i class="fa fa-edit"></i> Edit</a>
               @endif --}}
               {{-- <hr> --}}
...
<div class="modal-dialog" role="document">
  <div class="modal-content">
    ...
    <div class="modal-body text-center">
      <p>Are you sure you want to <span class="colored">DELETE</span> this information?</p> 
      <form action="{{ route('chancellor-journalcited-delete', $journalcited->id) }}" method="post">
        @csrf
        <button type="submit" class="btn btn-primary">Yes</button>
      </form>   
       <a href="" class="btn btn-primary" data-dismiss="modal">No</a>
  ...
  @if ($proposal->status== "PENDING" && $proposal->location_to == "Chancellor" || $proposal->status == "APPROVED")
  <div class="mt-2">
   <a href="{{ url('/chancellor/journal-cited/create/'.$proposal->id) }}" class="btn btn-primary float-right px-3"><i class="fas fa-plus pr-2"></i> ADD</a>
 </div>
 @endif
 </div>
       ...
       <td>
         <div class="w-25 dropdown pl-1">
           ...
           <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
             ...
             <a href="{{ route('chancellor-bookcited-edit', $bookcited->id) }}" class="dropdown-btn dropdown-item" aria-disabled="true"><i class="fa fa-edit"></i> Edit</a>
             @else
             <a href="/chancellor/book-cited/edit/{{$proposal->id}}/{{$bookcited->id}}" class="dropdown-btn dropdown-item"><i class="fa fa-edit"></i> Edit</a>
             @endif --}}
             {{-- <hr> --}}
...
<div class="modal-content">
  ...
  <div class="modal-body text-center">
    <p>Are you sure you want to <span class="colored">DELETE</span> this information?</p> 
    <form action="{{ route('chancellor-bookcited-delete', $bookcited->id) }}" method="post">
      @csrf
      <button type="submit" class="btn btn-primary">Yes</button>
    </form>   
     <a href="" class="btn btn-primary" data-dismiss="modal">No</a>
 ...
 @if ($proposal->status== "PENDING" && $proposal->location_to == "Chancellor" || $proposal->status == "APPROVED")
 <div class="mt-2">
 <a href="{{ url('/chancellor/book-cited/create/'.$proposal->id) }}" class="btn btn-primary float-right px-3"><i class="fas fa-plus pr-2"></i> ADD</a>
 </div>
 @endif
 ...
 <div class="modal-dialog modal-lg" role="document">
   <div class="modal-content">
     ...
     <div class="modal-body mx-0 pb-0 pt-3">
       <form class="proposal-form" action="{{ route('chancellor-rbp-view', $patented->id) }}" method="POST">
         @csrf
         @method('PUT')
       <div class="form-group text-left">
...
<div class="modal fade" id="patentedDeleteModal-{{ $patented->id }}" tabindex="-1" role="dialog" aria-labelledby="patentedDeleteModalLabel" aria-hidden="true">
 ...
 <div class="modal-content">
   ...
   <div class="modal-body text-center">
     <p>Are you sure you want to <span class="colored">DELETE</span> this information?</p> 
     <form action="{{ route('chancellor-patented-delete', $patented->id) }}" method="post">
       @csrf
       <button type="submit" class="btn btn-primary">Yes</button>
     </form>   
      <a href="" class="btn btn-primary" data-dismiss="modal">No</a>
...
@if ($proposal->status== "PENDING" && $proposal->location_to == "Chancellor" || $proposal->status == "APPROVED")
<div class="mt-2">
 <a href="{{ url('/chancellor/patented/create/'.$proposal->id) }}" class="btn btn-primary float-right px-3"  type="submit"><i class="fas fa-plus pr-2"></i> ADD</a>
     ...
     <td>
       <div class="w-27 dropdown pl-1">
         ...
         <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
           ...
           <a href="{{ route('chancellor-utilized-edit', $utilized->id) }}" class="dropdown-btn dropdown-item" aria-disabled="true"><i class="fa fa-edit"></i> Edit</a>
           @else
...
<div class="modal fade" id="utilizedEditModal-{{ $utilized->id }}" tabindex="-1" role="dialog" aria-labelledby="utilizedEditModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      ...
      <form class="proposal-form" action="{{ route('chancellor-utilized-update', $utilized->id) }}" method="POST" enctype="multipart/form-data">
        @csrf
        @method('PUT')
   ...
   <div class="modal fade" id="utilizedDeleteModal-{{ $utilized->id }}" tabindex="-1" role="dialog" aria-labelledby="deleteModalLabel" aria-hidden="true">
                              <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                  ...
                                  <div class="modal-body text-center">
                                    <p>Are you sure you want to <span class="colored">DELETE</span> this chancellor?</p> 
                                    <form action="{{ route('chancellor-utilized-delete', $utilized->id) }}" method="post">
                                      @csrf
                                      <button type="submit" class="btn btn-primary">Yes</button>
                                    </form>   
                                     <a href="" class="btn btn-primary" data-dismiss="modal">No</a>
  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body ">
        <form class="proposal-form" action="{{ route('chancellor-rbp-view', $proposal->id) }}" method="POST">
          @csrf
...
<div class="modal fade" id="utilizedAddModal" tabindex="-1" role="dialog" aria-labelledby="utilizedAddModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      ...
      <form class="proposal-form" action="{{ route('chancellor-rbp-view', $proposal->id) }}" method="POST" enctype="multipart/form-data">
        @csrf
      <div class="modal-body row mx-0 pb-0 pt-3">
