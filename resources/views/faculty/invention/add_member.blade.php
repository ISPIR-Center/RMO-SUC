          ...
          <div class="row ml-2 mb-2 py-3">
            <div class="col-xl-6 col-lg-12 pl-0">
              <h3 class="card-heading py-3">Add Proposal Members:</h3>
                <form action="{{ route('faculty-invention-addmembers', $proposal->id) }}" method="GET" class="search-form">
                  @csrf
                  ...
                  <table class="table table-rounded" >
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <form action="{{ route('faculty-invention-deletemember',[$proposal->id, $item->user_id]) }}" method="POST">
                          @csrf
                          @method('DELETE')
...
<a href="{{ route('faculty-invention-view', $proposal->id) }}" class="btn btn-primary float-right submit-proposal-btn"><i class="fas fa-check-circle"></i> DONE</a>
</div>
</div>
</div>
