  ...
  <div class="container-fluid py-2">
           ...
           <td>
             <div class="w-25 dropdown pl-4">
               ...
               <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                 <a href="{{ route('faculty-paperpresented-view', $paperpresented->id) }}" class="dropdown-btn dropdown-item"><i class="fa fa-eye"></i> View</a>
                 {{-- @if ($paperpresented->status =="APPROVED")
                 <a href="{{ route('faculty-paperpresented-edit', $paperpresented->id) }}" class="dropdown-btn dropdown-item" aria-disabled="true"><i class="fa fa-edit"></i> Edit</a>
                 @else
                 <a href="/faculty/paper-presented/edit/{{$proposal->id}}/{{$paperpresented->id}}" class="dropdown-btn dropdown-item"><i class="fa fa-edit"></i> Edit</a>
                 @endif --}}
                 <hr>
   ...
   <div class="modal fade" id="presentedDeleteModal-{{ $paperpresented->id }}" tabindex="-1" role="dialog" aria-labelledby="presentedDeleteModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
     ...
     <div class="mt-2">
      <a href="{{ url('/faculty/paper-presented/create/'.$proposal->id) }}" class="btn btn-primary float-right px-3" type="submit"><i class="fas fa-plus pr-2"></i> ADD</a>
    </div>
   </div>
       ...
       <tr class="unread text-center">
         ...
         <td>
           <div class="w-25 dropdown pl-4">
             ...
             <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
               <a href="{{ route('faculty-paperpublished-view', $paperpublished->id) }}" class="dropdown-btn dropdown-item"><i class="fa fa-eye"></i> View</a>
               {{-- @if ($paperpublished->status =="APPROVED")
               <a href="{{ route('faculty-paperpublished-edit', $paperpublished->id) }}" class="dropdown-btn dropdown-item" aria-disabled="true"><i class="fa fa-edit"></i> Edit</a>
               @else
               <a href="/faculty/paper-published/edit/{{$proposal->id}}/{{$paperpublished->id}}" class="dropdown-btn dropdown-item"><i class="fa fa-edit"></i> Edit</a>
               @endif --}}
               <hr>
...
<div class="modal-dialog" role="document">
  <div class="modal-content">
   ...
   <div class="mt-2">
     <a href="{{ url('/faculty/paper-published/create/'.$proposal->id) }}" class="btn btn-primary float-right px-3"><i class="fas fa-plus pr-2"></i> ADD</a>
   </div>
 </div>
         ...
         <td>
           <div class="w-25 dropdown pl-4">
             ...
             <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
               ...
               <a href="{{ route('faculty-journalcited-edit', $journalcited->id) }}" class="dropdown-btn dropdown-item" aria-disabled="true"><i class="fa fa-edit"></i> Edit</a>
               @else
               <a href="/faculty/journal-cited/edit/{{$proposal->id}}/{{$journalcited->id}}" class="dropdown-btn dropdown-item"><i class="fa fa-edit"></i> Edit</a>
               @endif --}}
               {{-- <hr> --}}
...
<div class="modal-dialog" role="document">
  ...
  <div class="mt-2">
   <a href="{{ url('/faculty/journal-cited/create/'.$proposal->id) }}" class="btn btn-primary float-right px-3"><i class="fas fa-plus pr-2"></i> ADD</a>
 </div>
 </div>
       ...
       <td>
         <div class="w-25 dropdown pl-1">
           ...
           <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
             ...
             <a href="{{ route('faculty-bookcited-edit', $bookcited->id) }}" class="dropdown-btn dropdown-item" aria-disabled="true"><i class="fa fa-edit"></i> Edit</a>
             @else
             <a href="/faculty/book-cited/edit/{{$proposal->id}}/{{$bookcited->id}}" class="dropdown-btn dropdown-item"><i class="fa fa-edit"></i> Edit</a>
             @endif --}}
             {{-- <hr> --}}
...
<div class="modal-content">
 ...
 <div class="mt-2">
 <a href="{{ url('/faculty/book-cited/create/'.$proposal->id) }}" class="btn btn-primary float-right px-3"><i class="fas fa-plus pr-2"></i> ADD</a>
 </div>
 <br><br>
 </div> 
<!-- -----------------------------------------I N V E N T I O N---------------------------------------------------------- -->
 ...
 <div class="modal-dialog modal-lg" role="document">
   <div class="modal-content">
     ...
     <div class="modal-body mx-0 pb-0 pt-3">
       <form class="proposal-form" action="{{ route('faculty-invention-view', $patented->id) }}" method="POST">
         @csrf
         @method('PUT')
       <div class="form-group text-left">
...
<div class="mt-2">
 <a href="{{ url('/faculty/patented/create/'.$proposal->id) }}" class="btn btn-primary float-right px-3"  type="submit"><i class="fas fa-plus pr-2"></i> ADD</a>
