...
<body class="ms-fill">
    ...
    <div class="d-flex wrapper" id="wrapper">
        ...
        <div id="page-content-wrapper">
          ...
          <div class="container-fluid">
            <!-- Page Title -->
            <h1 class="page-heading mt-2"><ion-icon name="grid-outline" size="large"></ion-icon> Generate Report</h1>
          
          </div>
          <!-- End of Content Header -->
          <form class="proposal-form" action="{{ route('rmo-view-report') }}" method="GET">
            @csrf
