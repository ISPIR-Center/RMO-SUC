          ...
          <div class="row ml-2 mb-2 py-3">
            <div class="col-xl-6 col-lg-12 pl-0">
              <h3 class="card-heading py-3">Add Proposal Members:</h3>
                <form action="{{ route('rmo-rbp-addmembers', [$proposal->id,$leaderid]) }}" method="GET" class="search-form">
                  @csrf
                        ...
                        @if ($faculties->count())
                          @foreach ($faculties as $item)
                            <tr>
                              ...
                              <form action="{{ route('rmo-rbp-addmember',[$proposal->id, $item->id]) }}" method="POST">
                                @csrf
                  ...
                  <table class="table table-rounded" >
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <form action="{{ route('rmo-rbp-deletemember',[$proposal->id, $item->user_id]) }}" method="POST">
                          @csrf
                          @method('DELETE')
...
<a href="{{ route('rmo-rbp-view', $proposal->id) }}" class="btn btn-primary float-right submit-proposal-btn"><i class="fas fa-check-circle"></i> DONE</a>
</div>
</div>
</div>
