       ...
       <tbody>
        @foreach ($paperpresenteds as $paperpresented)
         <tr class="unread text-center">
           ...
           <td>
            <a href="/programchair/paper-presented/view/{{$paperpresented->id}}/{{ $proposal->id }}" class="btn btn-secondary float-center"><i class="fas fa-eye"></i></a>
           </td>
         </tr>
       </tbody>
     </table>
     ...
     <tbody>
      @foreach ($paperpublisheds as $paperpublished)
       <tr class="unread text-center">
         ...
         <td>
          <a href="/programchair/paper-published/view/{{$paperpublished->id}}/{{ $proposal->id }}" class="btn btn-secondary float-center"><i class="fas fa-eye"></i></a>
         </td>
       </tr>
      </tr>
      <!-- DELETE UTILIZED -->
