...
<nav class="navbar navbar-light fixed-top bg-light p-0 shadow">
  <div class="container-fluid">
    <div class="py-3 m-0">
     <a href="{{ route('dean-rbp') }}"><img src="{{ asset('img/logo/rmo-logo.png') }}" class="navbar-office-logo"></a>
      </div>
...
<div class="d-flex wrapper" id="wrapper">
  ...
  <div class="border-end" id="sidebar-wrapper">
      ...
      <div class="sidebar-heading px-3 mt-4 text-muted row">
        ...
        <x-navbar.dean :active="$active"></x-navbar.dean>
  </div>
  @endif
@stop
           ...
           <td>
             <div class="w-25 dropdown pl-4">
               ...
               <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                 <a href="{{ route('dean-paperpresented-view', $paperpresented->id) }}" class="dropdown-btn dropdown-item"><i class="fa fa-eye"></i> View</a>
                 {{-- @if ($paperpresented->status =="APPROVED")
                 <a href="{{ route('dean-paperpresented-edit', $paperpresented->id) }}" class="dropdown-btn dropdown-item" aria-disabled="true"><i class="fa fa-edit"></i> Edit</a>
                 @else
                 <a href="/dean/paper-presented/edit/{{$proposal->id}}/{{$paperpresented->id}}" class="dropdown-btn dropdown-item"><i class="fa fa-edit"></i> Edit</a>
                 @endif --}}
                 <hr>
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body text-center">
          ...
          <form action="{{ route('dean-presented-delete', $paperpresented->id) }}" method="post">
            @csrf
     ...
     <div class="mt-2">
      <a href="{{ url('/dean/paper-presented/create/'.$proposal->id) }}" class="btn btn-primary float-right px-3" type="submit"><i class="fas fa-plus pr-2"></i> ADD</a>
    </div>
    @else
    @endif
   </div>
       ...
       <tr class="unread text-center">
         ...
         <td>
           <div class="w-25 dropdown pl-4">
             ...
             <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
               <a href="{{ route('dean-paperpublished-view', $paperpublished->id) }}" class="dropdown-btn dropdown-item"><i class="fa fa-eye"></i> View</a>
               {{-- @if ($paperpublished->status =="APPROVED")
               <a href="{{ route('dean-paperpublished-edit', $paperpublished->id) }}" class="dropdown-btn dropdown-item" aria-disabled="true"><i class="fa fa-edit"></i> Edit</a>
               @else
               <a href="/dean/paper-published/edit/{{$proposal->id}}/{{$paperpublished->id}}" class="dropdown-btn dropdown-item"><i class="fa fa-edit"></i> Edit</a>
               @endif --}}
               <hr>
...
<div class="modal-dialog" role="document">
  <div class="modal-content">
    ...
    <div class="modal-body text-center">
      <p>Are you sure you want to <span class="colored">DELETE</span> this information?</p> 
      <form action="{{ route('dean-published-delete', $paperpublished->id) }}" method="post">
        @csrf
        <button type="submit" class="btn btn-primary">Yes</button>
      </form>   
       <a href="" class="btn btn-primary" data-dismiss="modal">No</a>
   ...
   @if ($proposal->status== "PENDING" && $proposal->location_to == "Program Chair" || $proposal->status == "APPROVED")
   <div class="mt-2">
     <a href="{{ url('/dean/paper-published/create/'.$proposal->id) }}" class="btn btn-primary float-right px-3"><i class="fas fa-plus pr-2"></i> ADD</a>
   @endif
    </div>
 </div>
         ...
         <td>
           <div class="w-25 dropdown pl-4">
             ...
             <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
               ...
               <a href="{{ route('dean-journalcited-edit', $journalcited->id) }}" class="dropdown-btn dropdown-item" aria-disabled="true"><i class="fa fa-edit"></i> Edit</a>
               @else
               <a href="/dean/journal-cited/edit/{{$proposal->id}}/{{$journalcited->id}}" class="dropdown-btn dropdown-item"><i class="fa fa-edit"></i> Edit</a>
               @endif --}}
               {{-- <hr> --}}
...
<div class="modal-dialog" role="document">
  <div class="modal-content">
    ...
    <div class="modal-body text-center">
      <p>Are you sure you want to <span class="colored">DELETE</span> this information?</p> 
      <form action="{{ route('dean-journalcited-delete', $journalcited->id) }}" method="post">
        @csrf
        <button type="submit" class="btn btn-primary">Yes</button>
      </form>   
       <a href="" class="btn btn-primary" data-dismiss="modal">No</a>
  ...
  @if ($proposal->status== "PENDING" && $proposal->location_to == "Program Chair" || $proposal->status == "APPROVED")
  <div class="mt-2">
   <a href="{{ url('/dean/journal-cited/create/'.$proposal->id) }}" class="btn btn-primary float-right px-3"><i class="fas fa-plus pr-2"></i> ADD</a>
 </div>
 @endif
 </div>
       ...
       <td>
         <div class="w-25 dropdown pl-1">
           ...
           <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
             ...
             <a href="{{ route('dean-bookcited-edit', $bookcited->id) }}" class="dropdown-btn dropdown-item" aria-disabled="true"><i class="fa fa-edit"></i> Edit</a>
             @else
             <a href="/dean/book-cited/edit/{{$proposal->id}}/{{$bookcited->id}}" class="dropdown-btn dropdown-item"><i class="fa fa-edit"></i> Edit</a>
             @endif --}}
             {{-- <hr> --}}
...
<div class="modal-content">
  ...
  <div class="modal-body text-center">
    <p>Are you sure you want to <span class="colored">DELETE</span> this information?</p> 
    <form action="{{ route('dean-bookcited-delete', $bookcited->id) }}" method="post">
      @csrf
      <button type="submit" class="btn btn-primary">Yes</button>
    </form>   
     <a href="" class="btn btn-primary" data-dismiss="modal">No</a>
 ...
 @if ($proposal->status== "PENDING" && $proposal->location_to == "Program Chair" || $proposal->status == "APPROVED")
 <div class="mt-2">
 <a href="{{ url('/dean/book-cited/create/'.$proposal->id) }}" class="btn btn-primary float-right px-3"><i class="fas fa-plus pr-2"></i> ADD</a>
 </div>
 @endif
 <br><br>
 </div> 
 ...
 <div class="modal-dialog modal-lg" role="document">
   <div class="modal-content">
     ...
     <div class="modal-body mx-0 pb-0 pt-3">
       <form class="proposal-form" action="{{ route('dean-rbp-view', $patented->id) }}" method="POST">
         @csrf
         @method('PUT')
       <div class="form-group text-left">
...
<div class="modal fade" id="patentedDeleteModal-{{ $patented->id }}" tabindex="-1" role="dialog" aria-labelledby="patentedDeleteModalLabel" aria-hidden="true">
 ...
 <div class="modal-content">
   ...
   <div class="modal-body text-center">
     <p>Are you sure you want to <span class="colored">DELETE</span> this information?</p> 
     <form action="{{ route('dean-patented-delete', $patented->id) }}" method="post">
       @csrf
       <button type="submit" class="btn btn-primary">Yes</button>
     </form>   
      <a href="" class="btn btn-primary" data-dismiss="modal">No</a>
...
@if ($proposal->status== "PENDING" && $proposal->location_to == "Program Chair" || $proposal->status == "APPROVED")
<div class="mt-2">
 <a href="{{ url('/dean/patented/create/'.$proposal->id) }}" class="btn btn-primary float-right px-3"  type="submit"><i class="fas fa-plus pr-2"></i> ADD</a>
     ...
     <td>
       <div class="w-27 dropdown pl-1">
         ...
         <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
           ...
           <a href="{{ route('dean-utilized-edit', $utilized->id) }}" class="dropdown-btn dropdown-item" aria-disabled="true"><i class="fa fa-edit"></i> Edit</a>
           @else
...
<div class="modal fade" id="utilizedEditModal-{{ $utilized->id }}" tabindex="-1" role="dialog" aria-labelledby="utilizedEditModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      ...
      <form class="proposal-form" action="{{ route('dean-utilized-update', $utilized->id) }}" method="POST" enctype="multipart/form-data">
        @csrf
        @method('PUT')
   ...
   <div class="modal fade" id="utilizedDeleteModal-{{ $utilized->id }}" tabindex="-1" role="dialog" aria-labelledby="deleteModalLabel" aria-hidden="true">
                              <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                  ...
                                  <div class="modal-body text-center">
                                    <p>Are you sure you want to <span class="colored">DELETE</span> this dean?</p> 
                                    <form action="{{ route('dean-utilized-delete', $utilized->id) }}" method="post">
                                      @csrf
                                      <button type="submit" class="btn btn-primary">Yes</button>
                                    </form>   
                                     <a href="" class="btn btn-primary" data-dismiss="modal">No</a>
...
<div class="modal fade" id="utilizedAddModal" tabindex="-1" role="dialog" aria-labelledby="utilizedAddModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      ...
      <form class="proposal-form" action="{{ route('dean-rbp-view', $proposal->id) }}" method="POST" enctype="multipart/form-data">
        @csrf
      <div class="modal-body row mx-0 pb-0 pt-3">
