...
<div class="container-fluid py-2">
  <div class="card table-container">
    <div class="card-body card-body-proposal">
      <form class="proposal-form" action="{{ route('rmo-bookcited-create',$id) }}" method="POST" enctype="multipart/form-data">
        @csrf
        <div class="row pb-5">
          <div class="col-xl-6 ml-4">
            @error('book_title')
              ...
              <div class="form-group text-left">
                ...
                <input type="text" class="form-control" id="InputNewBookChapter" placeholder="Book Title" name="book_title" required>
              </div>
              @error('publisher')
                {{ $message }}
                @enderror
              <div class="form-group text-left">
                ...
                <input type="text" class="form-control" id="InputBookPublisher" placeholder="MLGH Publishing House" name="publisher" required>
              </div>
              @error('authors')
                {{ $message }}
                @enderror
              ...
              <div class="form-group text-left">
                ...
                <input type="text" class="form-control" id="InputAuthors" placeholder="https://bulsu-ovprde.com" name="link" value="https://" required>
              </div>
          </div>
          ...
          <div class="col-xl-5 ml-5">
            @error('isbn')
              ...
              <div class="form-group text-left">
                  ...
                  <input type="text" class="form-control" id="InputISBN" placeholder="Enter ISBN" name="isbn" required>
              </div>
              @error('year_published')
                ...
                @enderror
                  <div class="form-group text-left">
                      ...
                      <input type="date" class="form-control" id="InputBookCitedYearPublication" placeholder="Enter Year Publication" name="year_published" required>
                  </div>
              ...
              <div class="d-flex">
                ...
                @enderror
                  <div class="col-xl-6 form-group text-left">
                      ...
                      <input type="text" class="form-control" id="InputNoPages" placeholder="Enter No. Pages" name="pages" required>
                  </div>
              </div>
              <br><br><br><br><br>
              <div class="py-2">
