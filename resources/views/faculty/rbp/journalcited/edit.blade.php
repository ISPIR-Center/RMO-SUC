     ...
     <div class="container-fluid py-2">
        <div class="card table-container">
          <div class="card-body card-body-proposal">
            <form class="proposal-form" action="{{ route('faculty-journalcited-edit', [$proposalid,$data->id ]) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
              <div class="row pb-5">
                <div class="col-xl-6 ml-4">
                    <div class="form-group text-left">
                      ...
                      <input type="text" class="form-control" id="InputNewPublication" placeholder="Enter Journal Title" name="journal_title" value={{ $data->journal_title }} required>
                    </div>

                    <div class="form-group text-left">
                      <label for="InputJournalPublisher" class="card-heading py-3">Title of New Publication(Original Research was Cited)</label>
                      <input type="text" class="form-control" id="InputJournalPublisher" placeholder="Enter Program Title"  name="publisher" value={{ $data->publisher }} required>
                    </div>

                    <div class="form-group text-left">
                      <label for="InputAuthors" class="card-heading py-3">Author(s)</label>
                      <input type="text" class="form-control" id="InputAuthors" placeholder="Enter Authors" name="authors" value={{ $data->authors }} required>
                    </div>
                    ...
                    <div class="form-group text-left">
                      ...
                      <input type="text" class="form-control" id="InputAuthors" placeholder="Enter Author" name="file_1" value={{ $data->file_1 }} required>
                    </div>
                ...
                <div class="col-xl-5 ml-5">
                    ...
                    <div class="form-group text-left">
                        ...
                        <div class="form-group text-left">
                            ...
                            <input type="date" class="form-control" id="InputYearPublication" placeholder="Enter Year Publication" name="year_published" value={{ $data->year_published }} required>
                        </div>
                    ...
                    <div class="d-flex">
                        <div class="col-xl-6 pl-0 form-group text-left">
                            ...
                            <input type="text" class="form-control" id="InputProgramComponent" placeholder="Enter Vol. No." value="Vol. 83, No. 2" name="vol_no" value={{ $data->vol_no }} required>
                        </div>
