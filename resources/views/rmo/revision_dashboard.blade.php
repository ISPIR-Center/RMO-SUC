                      ...
                      @foreach ($proposals as $proposal)
                        <tr class="unread text-center">
                            ...
                            <td>
                                  ...
                                  <a href="/rmo/rbp/edit/revision/{{$proposal->id}}" class="btn btn-secondary"><i class="fas fa-edit"></i></a>
                                  <a href="#rbpDeleteModal-{{ $proposal->id }}"data-toggle="modal" class="btn btn-secondary"><i class="fas fa-trash"></i></a>                                
                                  @else
                                  <a href="/rmo/invention/view/{{$proposal->id}}" class="btn btn-secondary"><i class="fas fa-eye"></i></a>
                                  <a href="/rmo/invention/edit/{{$proposal->id}}" class="btn btn-secondary"><i class="fas fa-edit"></i></a>
                                  @endif
                      ...
                      <div class="modal fade" id="rbpDeleteModal-{{ $proposal->id }}" tabindex="-1" role="dialog" aria-labelledby="rbpDeleteModalLabel" aria-hidden="true">
                        ...
                        <div class="modal-content">
                          ...
                          <div class="modal-body text-center">
                            ...
                            <form action="{{ route('rmo-rbp-delete', $proposal->id) }}" method="post">
                              @csrf
