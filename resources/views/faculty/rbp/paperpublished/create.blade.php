 ...
 <div class="container-fluid py-2">
    <div class="card table-container">
      <div class="card-body card-body-proposal">
        <form class="proposal-form" action="{{ route('faculty-paperpublished-create',$id) }}" method="POST" enctype="multipart/form-data">
          @csrf
          <div class="row pb-5">
            <div class="col-xl-6 ml-4">
                <div class="form-group text-left">
                  <label for="InputJournalTitle" class="card-heading py-3">Journal Title*</label>
                  <input type="text" class="form-control" id="InputJournalTitle" placeholder="Enter Journal Title" name="journal_title" required>
                </div>

                <div class="form-group text-left">
                  <label for="InputPublisher" class="card-heading py-3">Authors*</label>
                  <input type="text" class="form-control" id="InputPublisher" placeholder="Enter Publisher" name="publisher" required>
                </div>

                <div class="form-group text-left">
                  <label for="InputPublisher" class="card-heading py-3">Publication Title*</label>
                  <input type="text" class="form-control" id="InputPublisher" placeholder="Enter Publisher" name="publication_title" required>
                </div>
            </div>
            ...
            <div class="col-xl-5 ml-5">
                ...
                <div class="form-group text-left">
                    ...
                    <select name="publication" class="form-control" id="InputPublication" aria-label="Gender">
                ...
                <div class="d-flex">
                    ...
                    <div class="col-xl-6 form-group text-left">
                        ...
                        <input type="date" class="form-control" id="InputYearAccepted" placeholder="Enter Year Accepted" name="year_accepted" required>
                    </div>
                    <div class="col-xl-6 form-group text-left">
                        <label for="InputYearPublished" class="card-heading py-3">Year Published*</label>
                        <input type="date" class="form-control" id="InputYearPublished" placeholder="Enter Year Published" name="year_published" required>
                    </div>
            ...
            <div class="proposal-files-container mt-4 ml-4">
                ...
                <div class="row">
                    ...
                    <div class="proposal-file-link pt-4 pb-5 px-3 text-center">
                      <div class="text-center file-upload">
                        <div class="file-upload-cont">
                          <label >
                            <input type="file" accept=".pdf" name="fileInputJTP" class="inputFile" required>
                            ...
                            <p class="pt-3" id="fileInputJTP">Upload File</p>  
                          </label>
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="proposal-file-link pt-4 pb-5 px-3 text-center">
                        <div class="text-center file-upload">
                          <div class="file-upload-cont">
                            <label >
                              <input type="file" accept=".pdf" name="fileInputTOC" class="inputFile" required>
                              <svg id="upload-icon" xmlns="http://www.w3.org/2000/svg" width="58.374" height="58.374" viewBox="0 0 58.374 58.374">
                                <path id="Path_737" data-name="Path 737" d="M0,0H58.374V58.374H0Z" fill="none"/>
                                <path id="Path_738" data-name="Path 738" d="M47.064,18.691a18.223,18.223,0,0,0-34.051-4.864,14.587,14.587,0,0,0,1.581,29.089H46.212a12.126,12.126,0,0,0,.851-24.225Zm-13.012,7.2v9.729H24.322V25.89h-7.3L29.187,13.729,41.348,25.89Z" transform="translate(0 5.729)" fill="#1565C0"/>
                              </svg>                          
                              <p class="pt-3" id="fileInputTOC">Upload File</p>  
                            </label>
                          </div>
                        </div>
                      </div>
                      ...
                      <div class="proposal-file-link pt-4 pb-5 px-3 text-center">
                        <div class="text-center file-upload">
                          <div class="file-upload-cont">
                            <label >
                              <input type="file" accept=".pdf" name="fileInputAP" class="inputFile" required>
                              <svg id="upload-icon" xmlns="http://www.w3.org/2000/svg" width="58.374" height="58.374" viewBox="0 0 58.374 58.374">
                                <path id="Path_737" data-name="Path 737" d="M0,0H58.374V58.374H0Z" fill="none"/>
                                <path id="Path_738" data-name="Path 738" d="M47.064,18.691a18.223,18.223,0,0,0-34.051-4.864,14.587,14.587,0,0,0,1.581,29.089H46.212a12.126,12.126,0,0,0,.851-24.225Zm-13.012,7.2v9.729H24.322V25.89h-7.3L29.187,13.729,41.348,25.89Z" transform="translate(0 5.729)" fill="#1565C0"/>
                              </svg>                          
                              <p class="pt-3" id="fileInputAP">Upload File</p>  
                            </label>
                          </div>
                        </div>
                      </div>
