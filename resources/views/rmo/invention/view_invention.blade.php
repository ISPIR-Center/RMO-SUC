      ...
      <div class="card-header">
        <div class="row">
          ...
          <div class="col py-3">
            ...
            <p class="status-text float-right m-0">Status: <span class="badge status-forrevision">PENDING</span></p>
            @else
            <p class="status-text float-right m-0">Status: <span class="badge status-inprogress">COMPLETED</span></p>
            @endif
          </div>
        </div>
      </div>
          ...
          <div class="row pb-5">
            <div class="col-xl-6 ml-4">
                ...
                <div class="form-group text-left">
                  ...
                  <p class="card-text">{{ $proposal->deliverables }}</p>
                </div>
           ...
           <td>
             <div class="w-25 dropdown pl-4">
               ...
               <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                 <a href="{{ route('rmo-paperpresented-view', $paperpresented->id) }}" class="dropdown-btn dropdown-item"><i class="fa fa-eye"></i> View</a>
                 {{-- @if ($paperpresented->status =="APPROVED")
                 <a href="{{ route('rmo-paperpresented-edit', $paperpresented->id) }}" class="dropdown-btn dropdown-item" aria-disabled="true"><i class="fa fa-edit"></i> Edit</a>
                 @else
                 <a href="/rmo/paper-presented/edit/{{$proposal->id}}/{{$paperpresented->id}}" class="dropdown-btn dropdown-item"><i class="fa fa-edit"></i> Edit</a>
                 @endif --}}
                 <hr>
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body text-center">
          ...
          <form action="{{ route('rmo-presented-delete', $paperpresented->id) }}" method="post">
            @csrf
     ...
     <div class="mt-2">
      <a href="{{ url('/rmo/paper-presented/create/'.$proposal->id) }}" class="btn btn-primary float-right px-3" type="submit"><i class="fas fa-plus pr-2"></i> ADD</a>
    </div>
   </div>
       ...
       <tr class="unread text-center">
         ...
         <td>
           <div class="w-25 dropdown pl-4">
             ...
             <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
               <a href="{{ route('rmo-paperpublished-view', $paperpublished->id) }}" class="dropdown-btn dropdown-item"><i class="fa fa-eye"></i> View</a>
               {{-- @if ($paperpublished->status =="APPROVED")
               <a href="{{ route('rmo-paperpublished-edit', $paperpublished->id) }}" class="dropdown-btn dropdown-item" aria-disabled="true"><i class="fa fa-edit"></i> Edit</a>
               @else
               <a href="/rmo/paper-published/edit/{{$proposal->id}}/{{$paperpublished->id}}" class="dropdown-btn dropdown-item"><i class="fa fa-edit"></i> Edit</a>
               @endif --}}
               <hr>
...
<div class="modal-dialog" role="document">
  <div class="modal-content">
    ...
    <div class="modal-body text-center">
      <p>Are you sure you want to <span class="colored">DELETE</span> this information?</p> 
      <form action="{{ route('rmo-published-delete', $paperpublished->id) }}" method="post">
        @csrf
        <button type="submit" class="btn btn-primary">Yes</button>
      </form>   
       <a href="" class="btn btn-primary" data-dismiss="modal">No</a>
   ...
   <div class="mt-2">
     <a href="{{ url('/rmo/paper-published/create/'.$proposal->id) }}" class="btn btn-primary float-right px-3"><i class="fas fa-plus pr-2"></i> ADD</a>
   </div>
 </div>
         ...
         <td>
           <div class="w-25 dropdown pl-4">
             ...
             <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
               ...
               <a href="{{ route('rmo-journalcited-edit', $journalcited->id) }}" class="dropdown-btn dropdown-item" aria-disabled="true"><i class="fa fa-edit"></i> Edit</a>
               @else
               <a href="/rmo/journal-cited/edit/{{$proposal->id}}/{{$journalcited->id}}" class="dropdown-btn dropdown-item"><i class="fa fa-edit"></i> Edit</a>
               @endif --}}
               {{-- <hr> --}}
...
<div class="modal-dialog" role="document">
  <div class="modal-content">
    ...
    <div class="modal-body text-center">
      <p>Are you sure you want to <span class="colored">DELETE</span> this information?</p> 
      <form action="{{ route('rmo-journalcited-delete', $journalcited->id) }}" method="post">
        @csrf
        <button type="submit" class="btn btn-primary">Yes</button>
      </form>   
       <a href="" class="btn btn-primary" data-dismiss="modal">No</a>
  ...
  <div class="mt-2">
   <a href="{{ url('/rmo/journal-cited/create/'.$proposal->id) }}" class="btn btn-primary float-right px-3"><i class="fas fa-plus pr-2"></i> ADD</a>
 </div>
 </div>
       ...
       <td>
         <div class="w-25 dropdown pl-1">
           ...
           <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
             ...
             <a href="{{ route('rmo-bookcited-edit', $bookcited->id) }}" class="dropdown-btn dropdown-item" aria-disabled="true"><i class="fa fa-edit"></i> Edit</a>
             @else
             <a href="/rmo/book-cited/edit/{{$proposal->id}}/{{$bookcited->id}}" class="dropdown-btn dropdown-item"><i class="fa fa-edit"></i> Edit</a>
             @endif --}}
             {{-- <hr> --}}
...
<div class="modal-content">
  ...
  <div class="modal-body text-center">
    <p>Are you sure you want to <span class="colored">DELETE</span> this information?</p> 
    <form action="{{ route('rmo-bookcited-delete', $bookcited->id) }}" method="post">
      @csrf
      <button type="submit" class="btn btn-primary">Yes</button>
    </form>   
     <a href="" class="btn btn-primary" data-dismiss="modal">No</a>
 ...
 <div class="mt-2">
 <a href="{{ url('/rmo/book-cited/create/'.$proposal->id) }}" class="btn btn-primary float-right px-3"><i class="fas fa-plus pr-2"></i> ADD</a>
 </div>
 <br><br>
 </div> 
<!-- -----------------------------------------I N V E N T I O N---------------------------------------------------------- -->
@elseif ($proposal->deliverables == "Invention")
<div class="card-body mt-3 mb-4">
 ...
 <div class="modal-dialog modal-lg" role="document">
   <div class="modal-content">
     ...
     <div class="modal-body mx-0 pb-0 pt-3">
       <form class="proposal-form" action="{{ route('rmo-invention-view', $patented->id) }}" method="POST">
         @csrf
         @method('PUT')
       <div class="form-group text-left">
...
<div class="modal fade" id="patentedDeleteModal-{{ $patented->id }}" tabindex="-1" role="dialog" aria-labelledby="patentedDeleteModalLabel" aria-hidden="true">
 ...
 <div class="modal-content">
   ...
   <div class="modal-body text-center">
     <p>Are you sure you want to <span class="colored">DELETE</span> this information?</p> 
     <form action="{{ route('rmo-patented-delete', $patented->id) }}" method="post">
       @csrf
       <button type="submit" class="btn btn-primary">Yes</button>
     </form>   
      <a href="" class="btn btn-primary" data-dismiss="modal">No</a>
...
<div class="mt-2">
 <a href="{{ url('/rmo/patented/create/'.$proposal->id) }}" class="btn btn-primary float-right px-3"  type="submit"><i class="fas fa-plus pr-2"></i> ADD</a>
     ...
     <td>
       <div class="w-27 dropdown pl-1">
         ...
         <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
           ...
           <a href="{{ route('rmo-utilized-edit', $utilized->id) }}" class="dropdown-btn dropdown-item" aria-disabled="true"><i class="fa fa-edit"></i> Edit</a>
           @else
...
<div class="modal fade" id="utilizedEditModal-{{ $utilized->id }}" tabindex="-1" role="dialog" aria-labelledby="utilizedEditModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      ...
      <form class="proposal-form" action="{{ route('rmo-utilized-update', $utilized->id) }}" method="POST" enctype="multipart/form-data">
        @csrf
        @method('PUT')
   ...
   <div class="modal fade" id="utilizedDeleteModal-{{ $utilized->id }}" tabindex="-1" role="dialog" aria-labelledby="deleteModalLabel" aria-hidden="true">
                              <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                  ...
                                  <div class="modal-body text-center">
                                    <p>Are you sure you want to <span class="colored">DELETE</span> this rmo?</p> 
                                    <form action="{{ route('rmo-utilized-delete', $utilized->id) }}" method="post">
                                      @csrf
                                      <button type="submit" class="btn btn-primary">Yes</button>
                                    </form>   
                                     <a href="" class="btn btn-primary" data-dismiss="modal">No</a>
  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body ">
        <form class="proposal-form" action="{{ route('rmo-rbp-view', $proposal->id) }}" method="POST">
          @csrf
...
<div class="modal fade" id="utilizedAddModal" tabindex="-1" role="dialog" aria-labelledby="utilizedAddModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      ...
      <form class="proposal-form" action="{{ route('rmo-rbp-view', $proposal->id) }}" method="POST" enctype="multipart/form-data">
        @csrf
      <div class="modal-body row mx-0 pb-0 pt-3">
