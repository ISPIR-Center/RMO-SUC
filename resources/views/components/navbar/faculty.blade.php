...
<nav id="sidebar">
    <div class="pt-3">
      ...
      <ul class="nav flex-column list-group">
        ...
        <x-navbar.li :navstatus="$active" name="facultyrbp">
          ...
          <div class="pl-4">
              <ul class="collapse collapse-group list-unstyled" id="manageProposal">
                  <li class="collapse-item">
                      <a href="{{ route('faculty-rbp')}}"><ion-icon name="folder-outline" class="pr-2" size="medium"></ion-icon> Research Based Paper</a>
                  </li> 
              </ul>

              <ul class="collapse collapse-group list-unstyled" id="manageProposal">
                  <li class="collapse-item">
                      <a href="{{ route('faculty-invention')}}"><ion-icon name="folder-outline" class="pr-2" size="medium"></ion-icon> Invention</a>
                  </li>
              </ul>
        ...
        <x-navbar.li :navstatus="$active" name="facultypending">
          <a class="nav-item-link" href="{{ route('faculty-pending') }}"><ion-icon name="document-text-outline" size="large"></ion-icon> Pending </a>
        </x-navbar.li>

          <x-navbar.li :navstatus="$active" name="facultyrevision">
            <a class="nav-item-link" href="{{ route('faculty-revision') }}"><ion-icon name="document-text-outline" size="large"></ion-icon> For Revision </a>
          </x-navbar.li>
          ...
          <x-navbar.li :navstatus="$active" name="manageaccount">
            ...
            <ul class="collapse collapse-group list-unstyled" id="manageAccount">
                <li class="collapse-item">
                    <a href={{ route('faculty-edit-profile',auth()->user()->id) }}><ion-icon name="lock-open-outline" size="large"></ion-icon> Edit Profile</a>
                </li>
            </ul>
            <ul class="collapse collapse-group list-unstyled" id="manageAccount">
              <li class="collapse-item">
                  <a href="{{ route('faculty-change') }}"><ion-icon name="lock-open-outline" size="large"></ion-icon> Change Password</a>
              </li>
          </ul>
        </x-navbar.li>
