  ...
  <div class="container-fluid">
    ...
    <div class="row mb-2">
      <div class="col-sm-9 pl-3 mt-3">
        <h1 class="page-heading mt-2"><ion-icon name="grid-outline" size="large"></ion-icon> Paper Published Details</h1>
          ...
          <div class="row pb-5">
            <div class="col-xl-6 ml-4">
              <div class="form-group text-left ml-4">
                ...
                <p>{{ $paperpublisheds->journal_title }}</p>
              </div>

              <div class="form-group text-left ml-4">
                <label for="InputPublicationTitle" class="card-heading py-3">Publication Title</label>
                <p>{{ $paperpublisheds->publication_title }}</p>
              </div>

              <div class="form-group text-left ml-4">
                <label for="InputPublisher" class="card-heading py-3">Publisher</label>
                <p>{{ $paperpublisheds->publisher }}</p>
              </div>
          </div>
                    ...
                    <div class="proposal-file-link pt-4 pb-5 px-3 text-center">
                        <div class="text-center proposal-file">
                            ...
                            <div class="proposal-cont">
                              ...
                              <p id="fileInputTxtCF">Journal Title Page</p>
                              <a href="{{ asset('requirements/' . $paperpublisheds->file_1) ."#toolbar=0" }}" target="_blank" class="btn btn-secondary" title="View Proposal"></i> View</a>
                            </div>
                          </div> 
                    </div>
                    ...
                    <div class="proposal-file-link pt-4 pb-5 px-3 text-center">
                        <div class="text-center proposal-file">
                            ...
                            <div class="proposal-cont">
                              ...
                              <p id="fileInputTxtCF">Table of Contents</p>
                              <a href="{{ asset('requirements/' . $paperpublisheds->file_2) ."#toolbar=0" }}" target="_blank" class="btn btn-secondary" title="View Proposal"></i> View</a>
                            </div>
                          </div> 
                      </div>
                      ...
                      <div class="proposal-file-link pt-4 pb-5 px-3 text-center">
                        <div class="text-center proposal-file">
                            ...
                            <div class="proposal-cont">
                              ...
                              <p id="fileInputTxtCF">Actual Pages</p>
                            <a href="{{ asset('requirements/' . $paperpublisheds->file_3) ."#toolbar=0" }}" target="_blank" class="btn btn-secondary" title="View Proposal"></i> View</a>
                            </div>
                          </div> 
                      </div>
