    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body text-center">
          ...
          <form action="{{ route('chancellor-paperpresented-reject', $paperpresented->id) }}" method="post">
            @csrf
            @method('PATCH')
            <input type="hidden" name="status" value="Rejected by the Chancellor">
        ...
        <form action="{{ route('chancellor-paperpresented-approve', $paperpresented->id) }}" method="POST">
          @csrf
          @method('PUT')
          <input type="hidden" name="status" value="Approved by the Chancellor">
          <button type="submit" class="btn btn-secondary float-lg-right"><i class="fas fa-check"></i></button>
        </form>
        <a href="/chancellor/paper-presented/view/{{$paperpresented->id}}/{{ $proposal->id }}" class="btn btn-secondary float-lg-right"><i class="fas fa-eye"></i></a>
           </td>
         </tr>
          <!-- DELETE UTILIZED -->
 ...
 <div class="modal fade" id="publishedreviseModal-{{ $paperpublished->id }}" tabindex="-1" role="dialog" aria-labelledby="publishedreviseModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body text-center">
        <p>Are you sure you want to <span class="colored">REJECT</span> this information?</p> 
        <form action="{{ route('chancellor-paperpublished-reject', $paperpublished->id) }}" method="post">
          @csrf
          @method('PATCH')
          <input type="hidden" name="status" value="Rejected by the Chancellor">
          <button type="submit" class="btn btn-primary ">Yes</button>
      ...
      <form action="{{ route('chancellor-paperpublished-approve', $paperpublished->id) }}" method="POST">
        @csrf
        @method('PUT')
        <input type="hidden" name="status" value="Approved by the Chancellor">
        <button type="submit" class="btn btn-secondary float-lg-right"><i class="fas fa-check"></i></button>
 ...
 <div class="modal fade" id="journalcitedreviseModal-{{ $journalcited->id }}" tabindex="-1" role="dialog" aria-labelledby="journalcitedreviseModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body text-center">
        <p>Are you sure you want to <span class="colored">REJECT</span> this information?</p> 
        <form action="{{ route('chancellor-journalcited-reject', $journalcited->id) }}" method="post">
          @csrf
          @method('PATCH')
          <input type="hidden" name="status" value="Rejected by the Chancellor">
          <button type="submit" class="btn btn-primary">Yes</button>
      ...
      <form action="{{ route('chancellor-journalcited-approve', $journalcited->id) }}" method="POST">
        @csrf
        @method('PUT')
        <input type="hidden" name="status" value="Approved by the Chancellor">
        <button type="submit" class="btn btn-secondary float-lg-right"><i class="fas fa-check"></i></button>
 ...
 <div class="modal fade" id="bookcitedreviseModal-{{ $bookcited->id }}" tabindex="-1" role="dialog" aria-labelledby="bookcitedreviseModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body text-center">
        <p>Are you sure you want to <span class="colored">REJECT</span> this information?</p> 
        <form action="{{ route('chancellor-bookcited-reject', $bookcited->id) }}" method="post">
          @csrf
          @method('PATCH')
          <input type="hidden" name="status" value="Rejected by the Chancellor">
          <button type="submit" class="btn btn-primary">Yes</button>
      ...
      <form action="{{ route('chancellor-bookcited-approve', $bookcited->id) }}" method="POST">
        @csrf
        @method('PUT')
        <input type="hidden" name="status" value="Approved by the Chancellor">
        <button type="submit" class="btn btn-secondary float-lg-right"><i class="fas fa-check"></i></button>
  ...
  <tbody>
   ...
   @foreach ($patenteds as $patented)
    <tr class="unread text-center">
      ...
      <td>
        <a href="/chancellor/rbp/view/{{$proposal->id}}" class="btn btn-secondary"><i class="fas fa-eye"></i></a>
        <a href="/chancellor/rbp/view/{{$proposal->id}}" class="btn btn-secondary"><i class="fas fa-check"></i></a>
        <a href="/chancellor/rbp/view/{{$proposal->id}}" class="btn btn-secondary"><i class="fas fa-times"></i></a>
      </td>
    </tr>
    <!-- Patented Modal Edit -->
...
<div class="modal fade" id="utilizedEditModal-{{ $utilized->id }}" tabindex="-1" role="dialog" aria-labelledby="utilizedEditModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg" role="document">
   ...
   @endif
    ...
    @else
     @endif
     <form action="{{ route('chancellor-rbp-reject',$proposal->id) }}" method="post">
      @csrf
      @method('PUT')
  ...
  <form action="{{ route('chancellor-rbp-approve',$proposal->id) }}" method="post">
    @csrf
    @method('PUT')
    @if($paperpresenteds->count() || $paperpublisheds->count() || $bookciteds->count() || $journalciteds->count() || $utilizeds->count() || $patenteds->count())
