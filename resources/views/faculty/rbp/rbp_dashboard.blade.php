...
<body class="ms-fill">
    ...
    <div class="d-flex wrapper" id="wrapper">
        ...
        <div id="page-content-wrapper">
          ...
          <div class="container-fluid">
            <!-- Page Title -->
            <h1 class="page-heading mt-2"><ion-icon name="folder-outline" size="large"></ion-icon> Research Based Paper List</h1>
                ...
                <div class="row mb-2">
                  ...
                  <div class="col-sm-6">
                    {{-- <button type="button" class="btn btn-lg btn-light float-right" data-bs-toggle="modal" data-bs-target="#exampleModal"> --}}
                      <a href="{{ route('faculty-rbp-create') }}" class="btn btn-lg btn-light float-right">Add Research <i class="fas fa-plus"></i></a>
                  </a>
                  </div>
                </div>
              </div>
                  ...
                  <tbody>
                    @if ($proposals->count())
                      @foreach ($proposals as $proposal)
                        <tr class="clickable-row unread" data-href="{{ url('/faculty/rbp/view/'.$proposal->id) }}">
                            ...
                            {{-- @elseif($proposal->location_from =="RMO" AND $proposal->location_to =="RMO")
                            <td><span class="badge status-pending">APPROVED</span></td> --}}
                            @else
                      ...
                      @endforeach
                    @else
                        <td colspan="9" class="text-center td-noproposals">No Researches</td>
                    @endif
