     ...
     <div class="container-fluid py-2">
        <div class="card table-container">
          <div class="card-body card-body-proposal">
            <form class="proposal-form" action="{{ route('faculty-bookcited-edit', [$proposalid,$data->id ]) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
              <div class="row pb-5">
                <div class="col-xl-6 ml-4">
                    ...
                    <div class="form-group text-left">
                      ...
                      <input type="text" class="form-control" id="InputBookPublisher"  name="file_1" value={{ $data->file_1 }}  required>
                    </div>
