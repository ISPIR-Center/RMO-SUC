  ...
  <div class="container-fluid py-2">
   ...
   <div class="modal fade" id="presentedDeleteModal-{{ $paperpresented->id }}" tabindex="-1" role="dialog" aria-labelledby="presentedDeleteModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
     ...
     @if ( $paperpresenteds->count() || $paperpublisheds->count() || $bookciteds->count() ||$journalciteds->count() || $proposal->location_to == "Dean"|| $proposal->location_to == "Chancellor"|| $proposal->location_to == "RMO")
     @else
     {{-- @if( !$paperpresenteds->count() || !$paperpublisheds->count() || !$journalciteds->count() || !$bookciteds->count()) --}}
     <div class="mt-2">
