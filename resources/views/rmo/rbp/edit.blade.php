       ...
       <div class="container-fluid py-2">
        <div class="card table-container">
          <div class="card-body card-body-proposal">
            <form class="proposal-form" action="{{ route('rmo-rbp-edit', $data->id) }}" method="POST" enctype="multipart/form-data">
              @csrf
              @method('PUT')
              <div class="row py-1">
                ...
                <div class="d-flex ">
                   <div class="form-group text-left col-xl-6 px-0">
                    ...
                    <input type="text" class="form-control" id="InputProgramComponent" name="funded_on" required value= {{ $data->funded_on }} >
                   </div>
                   <div class="form-group text-left col-xl-6 px-0 ml-2">
                    <label for="InputDateCompleted" class="card-heading py-3"> Budget Issued (BSU)</label>
                    <input type="text" class="form-control" id="InputDateCompleted" name="budget_bsu" required value={{ $data->budget_bsu }} >
                   </div>
                </div>
             </div>
                    ...
                    @foreach ($paperpresenteds as $paperpresented)
                     <tr class="unread text-center">
                       ...
                       <td>
                        ...
                        <a href="/rmo/paper-presented/edit/{{ $data->id }}/{{$paperpresented->id}}" class="btn btn-secondary"><i class="fas fa-edit"></i></a>
                  ...
                  @foreach ($paperpublisheds as $paperpublished)
                   <tr class="unread text-center">
                     ...
                     <td>
                      ...
                      <a href="/rmo/paper-published/edit/{{ $data->id }}/{{$paperpublished->id}}" class="btn btn-secondary"><i class="fas fa-edit"></i></a>
                  ...
                  @foreach ($journalciteds as $journalcited)
                   <tr class=" unread text-center" >
                     ...
                     <td>
                      ...
                      <a href="/rmo/journal-cited/edit/{{ $data->id }}/{{$journalcited->id}}" class="btn btn-secondary"><i class="fas fa-edit"></i></a>
                ...
                @foreach ($bookciteds as $bookcited)
                 <tr class="unread text-center">
                   ...
                   <td>
                    ...
                    <a href="/rmo/book-cited/edit/{{ $data->id }}/{{$bookcited->id}}" class="btn btn-secondary"><i class="fas fa-edit"></i></a>
              ...
              <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                  ...
                  <div class="modal-body ">
                    <form class="proposal-form" action="{{ route('rmo-rbp-view', $data->id) }}" method="POST">
                      @csrf
            ...
            <div class="modal fade" id="utilizedAddModal" tabindex="-1" role="dialog" aria-labelledby="utilizedAddModalLabel" aria-hidden="true">
              <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                  ...
                  <form class="proposal-form" action="{{ route('rmo-rbp-view', $data->id) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                  <div class="modal-body row mx-0 pb-0 pt-3">
