 ...
 <div class="container-fluid py-2">
  <div class="card table-container">
    <div class="card-body card-body-proposal">
      <form class="proposal-form" action="{{ route('faculty-journalcited-create',$id) }}" method="POST" enctype="multipart/form-data">
        @csrf
        <div class="row pb-5">
          <div class="col-xl-6 ml-4">
            ...
            <div class="form-group text-left">
              <label for="InputNewPublication" class="card-heading py-3">Title of New Rerefeed Journal(Original Research was Published)</label>
              <input type="text" class="form-control" id="InputNewPublication" placeholder="Enter New Publication" name="journal_title" required>
            </div>
            @error('publisher')
                {{ $message }}
                @enderror
            <div class="form-group text-left">
              <label for="InputJournalPublisher" class="card-heading py-3">Title of New Publication(Original Research was Cited)</label>
              <input type="text" class="form-control" id="InputJournalPublisher" placeholder="Enter Journal Publisher" name="publisher" required>
            </div>
            @error('authors')
                {{ $message }}
                @enderror
            <div class="form-group text-left">
              ...
              <input type="text" class="form-control" id="InputAuthors" placeholder="Enter Author" name="authors" required>
            </div>
            <div class="form-group text-left">
              <label for="InputAuthors" class="card-heading py-3">Title of Refereed Journal(New Research was Published)<a tabindex="0" class="colored" role="button" data-toggle="popover" data-trigger="hover" data-html="true" data-content="Make sure to add 'https://' in the beginning of the link if you manually type it."><i class="fa fa-info-circle"></i></a></label>
              <input type="text" class="form-control" id="InputAuthors" placeholder="Enter Author" name="file_1"  required>
            </div>
            @error('link')
                {{ $message }}
                @enderror
            <div class="form-group text-left">
              ...
              <input type="text" class="form-control" id="InputAuthors" placeholder="Enter Author" name="link" value="https://" required>
            </div>
        </div>
        ...
        <div class="col-xl-5 ml-5">
          ...
          @enderror
            <div class="form-group text-left">
                ...
                <select class="form-control" id="InputPublication" aria-label="Gender" name="publication">
            ...
            @error('year_published')
                ...
                @enderror
                <div class="form-group text-left">
                    <label for="InputYearPublication" class="card-heading py-3">Year Cited</label>
                    <input type="date" class="form-control" id="InputYearPublication" placeholder="Enter Year Publication" name="year_published" required>
                </div>
            ...
            <div class="d-flex">
              @error('vol_no')
                ...
                <div class="col-xl-6 form-group text-left">
                    ...
                    <input type="text" class="form-control" id="InputProgramComponent" placeholder="Enter Vol. No. / Issue No." name="vol_no" required>
                </div>
                @error('pages')
                {{ $message }}
                @enderror
                <div class="col-xl-6 form-group text-left">
                    ...
                    <input type="text" class="form-control" id="InputNoPages" placeholder="Enter No of Pages" name="pages" required>
                </div>
            </div>
            <br><br><br><br><br>
            <div class="py-2">
