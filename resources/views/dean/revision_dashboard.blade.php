...
<body class="ms-fill">
    ...
    <div class="d-flex wrapper" id="wrapper">
        ...
        <div id="page-content-wrapper">
          ...
          <div class="container-fluid">
            <!-- Page Title -->
            <h1 class="page-heading mt-2"><ion-icon name="grid-outline" size="large"></ion-icon> For Revision Researches</h1>
                ...
                <table class="table table-hover bg-white">
                  <thead>
                    <tr class="text-center">
                      <th scope="col" width="28%">Research Title</th>
                      <th scope="col" width="33%"> Remarks</th>
                      <th scope="col" width="15%">Deliverable</th>
                      <th scope="col" width="15%">Declined by</th>
                    </tr>
                  </thead>
                  <tbody>
                    @if ($proposals->count())
                      @foreach ($proposals as $proposal)
                      <tr class="clickable-row unread text-center" data-href="{{ url('/dean/revision/view/'.$proposal->id) }}">
