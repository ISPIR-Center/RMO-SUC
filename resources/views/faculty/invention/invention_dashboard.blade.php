                ...
                <div class="row mb-2">
                  ...
                  <div class="col-sm-6">
                    {{-- <button type="button" class="btn btn-lg btn-light float-right" data-bs-toggle="modal" data-bs-target="#exampleModal"> --}}
                      <a href="{{ route('faculty-invention-create') }}" class="btn btn-lg btn-light float-right">Add Invention <i class="fas fa-plus"></i></a>
                  </a>
                  </div>
                </div>
              </div>
                ...
                <table class="table table-hover bg-white">
                  ...
                  <tbody>
                    @if ($proposals->count())
                      ...
                      @endforeach
                    @else
                        <td colspan="9" class="text-center td-noproposals">No Invention</td>
                    @endif
