 ...
 <div class="container-fluid py-2">
    <div class="card table-container">
      <div class="card-body card-body-proposal">
        <form class="proposal-form" action="{{ route('faculty-paperpresented-create',$id) }}" method="POST" enctype="multipart/form-data">
          @csrf
          <div class="row pb-5">
            <div class="col-xl-6 ml-4">
              ...
              {{ $message }}
               @enderror
                ...
                @enderror
                <div class="form-group text-left">
                  <label for="InputPublicationTitle" class="card-heading py-3">Conference Title*</label>
