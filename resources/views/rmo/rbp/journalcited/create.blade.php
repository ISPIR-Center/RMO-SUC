 ...
 <div class="container-fluid py-2">
  <div class="card table-container">
    <div class="card-body card-body-proposal">
      <form class="proposal-form" action="{{ route('rmo-journalcited-create',$id) }}" method="POST" enctype="multipart/form-data">
        @csrf
        <div class="row pb-5">
          <div class="col-xl-6 ml-4">
            ...
            <div class="form-group text-left">
              <label for="InputNewPublication" class="card-heading py-3">Title of New Publication</label>
            ...
            @error('publisher')
                ...
                @enderror
            <div class="form-group text-left">
              <label for="InputJournalPublisher" class="card-heading py-3">Journal Publisher</label>
