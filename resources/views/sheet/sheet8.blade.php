...
<body>
          ...
          <div class="container py-4 px-4">
                ...
                <div class="card-body py-4 text-center">
                  ...
                  <h3>SUMMARY SHEET</h3>
                  <h3 class="pb-4">FORM SL KRA 2.5b Research-based Paper Cited by Book Authors</h3>

                  <table class="table table-bordered">
                    <thead>
                      <tr>
                        <th scope="col"><b>PERIOD COVERED</b></th>
                        <th scope="col"><b>Total Number of Research-based Papers Cited by Books Authors
